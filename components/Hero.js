      ...
      <div className="relative z-10 flex flex-col md:flex-row max-w-5xl mx-auto w-full pt-[25vh] pb-12 px-4 gap-8">
        ...
        <div className="flex-1 space-y-4">
          ...
          <p className="text-base md:text-lg text-support max-w-md">
            Eu estou aqui, <strong>online</strong>, pronta para te <strong>acolher</strong> e ajudar a <strong>dar voz</strong> ao que você sente. Vamos marcar sua primeira conversa pelo <strong>WhatsApp</strong>? A psicanálise pode ser esse espaço de <strong>clareza</strong> e <strong>leveza</strong> que você <strong>merece</strong>.
          </p>
